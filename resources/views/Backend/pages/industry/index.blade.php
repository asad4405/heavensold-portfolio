...
@section('maincontent')
    <div class="card m-5">
        <div class="card-title"
            ...
            <h5>Industry Section</h5>
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Add">Add Industry</button>
        </div>
                    ...
                    <tbody>
                        @foreach ($industries as $value)
                            <tr>
                                ...
                                <td>
                                    <a class="text-white btn btn-sm btn-primary" href="{{ route('admin.industry.edit',$value->id) }}"><i class="fa-solid fa-pen-to-square"></i></a>
                                    {{-- <a href="{{ route('admin.industry.destroy',$value->id) }}" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash"></i></a> --}}
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel3">Add Industry Data</h5>
